...
We can actually try out a bit of coding at this point. Try entering the following into the console and hitting enter.
...
**Congratulations!** If this is your first time using R, then you just ran your first command!
...
There is a bit of vocabulary to know that will help you use R. *Commands* are any instructions you give to R in the console. You enter text after the ">" sign in the console and hit <enter> on the keyboard to give R commands. The R environment runs primarily by creating *objects* and applying *functions* to them. In order for R to do things with an object, it has to know that it exists.
